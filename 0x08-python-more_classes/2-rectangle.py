...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """
        Checks parameters before initializes some values
        Args:
    ...
    def __check_valid_width(self, width):#To check if width is a valid integer
        """Args:
    ...
    def __check_valid_height(self, height):#To check if height is a valid integer
        """Args:
    ...
    def __check_int_value(self, value):#To check if value is an integer
        """Args:
    ...
    def __check_positive_value(self, value):# To check if value is a positive integer
        """ value (int): The number to verify
        Returns:
    ...
    def area(self):#To Compute the area of a Rectangle.
        """Returns:
    ...
    def perimeter(self):#To compute the perimeter of a Rectangle.
        """Returns:
            int: The Rectangle parimeter.
        """
