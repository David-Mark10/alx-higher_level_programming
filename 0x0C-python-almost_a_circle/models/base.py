...
class Base:
    """To represent base model.

    Represents "base" for the classes in project 0x0C*.
    ...
    def to_json_string(list_dictionaries):
        ...
        Args:
            list_dictnaries (list): A list of dictnaries.
        """
    ...
    def draw(list_rectangles, list_squares):
        """
            resent Rectangles and Squares using the turtle module.
